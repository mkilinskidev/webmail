...
module.exports = function (oAppData) {
	...
	var
		...
		MailSettings = __webpack_require__(/*! modules/MailWebclient/js/Settings.js */ "p2hp")
	;
...
//	require('node_modules/framework7/dist/css/framework7.ios.colors.css');
	...
	if (App.isUserNormalOrTenant())
	{
		if (App.isMobile())
		{
			...
			Cache.init();
			var AccountList = __webpack_require__(/*! modules/MailWebclient/js/AccountList.js */ "jonm");
			...
			return {
				...
				getScreens: function () {
					...
					oScreens[MailSettings.HashModuleName] = function () {
						return __webpack_require__(/*! modules/MailMobileWebclient/js/views/MailView.js */ "TFyw");
					};
					oScreens[MailSettings.HashModuleName + '-compose'] = function () {
						return __webpack_require__(/*! modules/MailMobileWebclient/js/views/ComposeView.js */ "DT0j");
					};
					return oScreens;
				},
				getHeaderItem: function () {
					return {
						item: __webpack_require__(/*! modules/MailMobileWebclient/js/views/HeaderItemView.js */ "0qB7"),
						name: MailSettings.HashModuleName
					};
				},
				registerComposeToolbarController: function (oController) {
					var ComposeView = __webpack_require__(/*! modules/MailMobileWebclient/js/views/ComposeView.js */ "DT0j");
...
function CMessagePaneView()
{
	...
	this.oUnsubscribeButtonView = __webpack_require__(/*! modules/MailWebclient/js/views/message-pane/UnsubscribeButtonView.js */ "PoFh"),
...
ComposeView.executeBackToList = function ()
{
	...
	{
		var
			HeaderItemView = __webpack_require__(/*! modules/MailMobileWebclient/js/views/HeaderItemView.js */ "0qB7"),
			Routing = __webpack_require__(/*! modules/CoreWebclient/js/Routing.js */ "QaF5")
		;
...
var
	...
	CFolderListView = __webpack_require__(/*! modules/MailMobileWebclient/js/views/CFolderListView.js */ "GfJb"),
	CMailView = __webpack_require__(/*! modules/MailWebclient/js/views/CMailView.js */ "qu3M")
;
