...
var
	...
	ConfirmAnotherMessageComposedPopup = __webpack_require__(/*! modules/MailScheduledMessages/js/popups/ConfirmAnotherMessageComposedPopup.js */ "lkAb"),
	Schedule = __webpack_require__(/*! modules/MailScheduledMessages/js/utils/Schedule.js */ "FJ/b"),

	Settings = __webpack_require__(/*! modules/MailScheduledMessages/js/Settings.js */ "QYWL")
;
		...
		return {
			start: function (ModulesManager) {
				if (ModulesManager.isModuleEnabled('MailWebclient')) {
					...
					ModulesManager.run('MailWebclient', 'registerComposeToolbarController', [__webpack_require__(/*! modules/MailScheduledMessages/js/views/ComposeSendButtonView.js */ "bEen")]);
					...
					App.subscribeEvent('MailWebclient::RegisterMessagePaneController', function (fRegisterMessagePaneController) {
						fRegisterMessagePaneController(__webpack_require__(/*! modules/MailScheduledMessages/js/views/ScheduledInfoView.js */ "/OsY"), 'BeforeMessageBody');
					});
				}
			}
		};
...
var
	...
	ScheduleUtils = __webpack_require__(/*! modules/MailScheduledMessages/js/utils/Schedule.js */ "FJ/b"),
...
var
	...
	ScheduleSendingPopup = __webpack_require__(/*! modules/MailScheduledMessages/js/popups/ScheduleSendingPopup.js */ "Gj8G")
;
